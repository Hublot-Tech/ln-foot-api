...
public class DataSyncScheduler {
    ...
    /**
     * Periodically performs a comprehensive sync of fixtures, typically for the
     * current day.
     * Configurable via `application.sync.dailyCron`, defaults to daily at 00:05 AM
     * UTC.
     */
    ...
    public void scheduleDailyFullSync() {
        ...
        try {
            ...
            // e.g., specific leagues if `interestedLeagues` filtering in service is not
            // sufficient
     ...
     * Configurable via `application.sync.hourlyCron`, defaults to hourly at the
    ...
    public void scheduleHourlyRecentFixturesSync() {
        ...
        try {
            Map<String, String> queryParams = new HashMap<>();
            // Parameter "live=all" is hypothetical and depends on the external API
            // supporting it.
            ...
            // Alternatively, this could fetch fixtures for a very narrow recent time
            // window.
