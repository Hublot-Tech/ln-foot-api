...
public class FixtureServiceImpl implements FixtureService {
    ...
    private FixtureDto mapToDto(Fixture entity) {
        ...
        return FixtureDto.builder()
                ...
                .scoreEtAway(entity.getScoreEtAway())
                .scoreEtHome(entity.getScoreEtHome())
                .scoreFtAway(entity.getScoreFtAway())
                .scoreFtHome(entity.getScoreFtHome())
                .scoreHtAway(entity.getScoreHtAway())
                .scoreHtHome(entity.getScoreHtHome())
                .scorePtAway(entity.getScorePtAway())
                .scorePtHome(entity.getScorePtHome())
